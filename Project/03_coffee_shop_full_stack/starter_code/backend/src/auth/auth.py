...
@TODO implement verify_decode_jwt(token) method
    ...
    Ce devrait être un jeton Auth0 avec ID clé (Kid)
    Il doit vérifier le jeton à l'aide de Auth0 /.well-Known/jwks.json
    il devrait décoder la charge utile du jeton
    il devrait valider les réclamations
    retourner la charge utile décodée
